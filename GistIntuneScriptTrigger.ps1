...
`u{1F195} 2026-02-03: Updated - Nr.10 - Show-SecureBootCerts
"@
...
$GistCatalog = @(
    ...
    [ordered] @{
        ...
        Category    = "Windows"
        Url         = "https://raw.githubusercontent.com/MrWyss-MSFT/SecureBootCerts/46161a17f12bc22c7b17c12215f526c3984ad970/Show-SecureBootCerts.ps1"
